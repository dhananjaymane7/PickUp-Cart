...
const CargoOrdersummery = () => {
    ...
    const productRate = price?.rate;
    const productRate1 = parseFloat(productRate);
    const gstAmount = productRate1 * gstRate;
    const productRate2 = parseFloat(gstAmount.toFixed(0));
    const totalAmount = productRate1 + productRate2
    ...
    return (
        <div className="container  bg-slate-100 ">
            ...
            <form className="grid  pt-6 pb-10 lg:mx-20 gap-8 grid-cols-3" onSubmit={handleSubmit}>
                ...
                <div class="max-w-xl rounded-lg shadow-lg bg-white p-8 mx-auto">
                    <div>
                        ...
                        <div className="md:grid md:grid-cols-2 gap-x-4">
                            ...
                            <div class="relative z-0 w-full mb-5 group">
                                <input type="text" value={formData.ppin}
                            ...
                            <div class="relative z-0 w-full mb-5 group">
                                <input type="text" value={formData.paddress}
                    ...
                    <div>
                        ...
                        <div className="md:grid md:grid-cols-2 gap-x-4">
                            ...
                            <div class="relative z-0 w-full mb-5 group">
                                <input type="text" value={formData.dpin}
                            ...
                            <div class="relative z-0 w-full mb-5 group">
                                <input type="text" value={formData.daddress}
                        ...
                        <div class="bg-white pb-10 ">
                            ...
                            <div class=" w-72 lg:w-5/6 m-auto bg-indigo-50 mt-5 p-4 lg:p-4 rounded-2xl">
                                <div class=" flex mx-10  gap-4 pt-1">
                                    ...
                                    <p class="text-gray-800  font-bold lg:text-xl">₹ {totalAmount} </p>
                                </div>
                            </div>
