...
const Report = () => {
 ...
 const handleClick = () =>{
    axios.post("https://pickupkart.in/api/book",AllData);
    ...
    return(
        ...
        <section className="w-full h-full overflow-x-hidden">
                    ...
                    <div className="max-[640px]:gap-8 flex-div">
                        ...
                        <div className="one">
                            <div>
                                ...
                                <div className="shape parcel max-[640px]:w-10 max-[640px]:h-10 bg-[#EAB54F]">
                                    <img className="icon-1 z-30 max-[640px]:top-[28%] max-[640px]:left-[29%] max-[640px]:w-[1.1rem]" src={whiteparsal} width="20px" alt=""/>
                                </div>
                        ...
                        <div className="one middle">
                            <div>
                                ...
                                <div className="shape date max-[640px]:w-10 max-[640px]:h-10 bg-[#EAB54F]">
                                    <img className="icon-1 max-[640px]:top-[28%] max-[640px]:left-[29%] max-[640px]:w-[1.1rem]" src={whiteclock} width="20px" alt=""/>
                                </div>
                        ...
                        <div className="one middle">
                            <div>
                                ...
                                <div className="shape report max-[640px]:w-10 max-[640px]:h-10 bg-[#EAB54F]">
                                    <img className="icon-1 max-[640px]:top-[25%] max-[640px]:left-[29%] max-[640px]:w-[1.1rem]" src={whitereport} width="20px" alt=""/>
                                </div>
            ...
            <section className="w-full relative bg-[url('')] h-[960px] img1">
                ...
                <div className="flex flex-col gap-8 pl-8 max-[475px]:pl-3 w-[70%] items-center mx-auto pt-24 max-[768px]:flex-col max-[1219px]:items-center max-[475px]:pt-10 max-[1219px]:pt-0">
                    <p className="text-[21px] font-ROBOTO font-bold -mb-4 -ml-8 max-[1219px]:-ml-8 max-[640px]:text-[18px] pt-8">Order Report</p>
    
                    <div className="flex flex-row max-[1219px]:flex-col">
                        <div className="flex flex-col pr-6 border bg-white max-[1024px]:ml-7 max-[1219px]:mb-5  shadow-lg gap-14 pl-7 rounded-xl max-[1400px]:mr-8 max-[475px]:pl-3 ">
                            <div className="flex flex-row justify-between -mb-6">
    
                                <p className="text-[21px] font-ROBOTO font-bold -mb-4 max-[640px]:text-[18px] pt-8">Location</p>
                                <p className="text-[16px] font-ROBOTO font-bold text-[#EAB54F] -mb-4 max-[640px]:text-[12px] pt-8">Update</p>
                            </div>
    
                            <div className="flex flex-row gap-5 mb-[-50px]">
                                <div>
                                ...
                                <div className="flex flex-col gap-5 w-[70%] pb-5">
                            ...
                            <div className="bg-[#F3F8FD] w-[116%] max-[1219px]:w-[115%] max-[680px]:w-[120%] max-[475px]:ml-[-12px] max-[475px]:w-[114%] max-[680px]:ml-[-28px] h-full ml-[-28px] pt-8 pb-5">
                                <div className="flex flex-row ml-10 ">
                                    <p className="text-[16px] font-ROBOTO font-bold  max-[640px]:text-[13px] pr-7">Total Cost:</p>
                                    <p className="text-[18px] font-ROBOTO font-bold  max-[640px]:text-[16px]">
                                         ₹ {price}
                                         
                                         </p>
                                </div>
                                        <p className="text-[12px] font-ROBOTO font-medium opacity-70 max-[640px]:text-[9px] pl-10">Delivery in 5-7 days</p>
                            </div>
                        ...
                        <div className="flex flex-col pr-6 bg-white border max-[1024px]:ml-7  max-[1024px]:pb-8 shadow-lg gap-4 pl-7 rounded-xl max-[1400px]:mr-8 max-[475px]:pl-3 max-[711px]:mb-0 ">
                            <div className="flex flex-row justify-between mb-8">
    
                                <p className="text-[21px] font-ROBOTO font-bold -mb-4 max-[640px]:text-[18px] pt-8">Parcel Details</p>
                                <p className="text-[16px] font-ROBOTO font-bold text-[#EAB54F] -mb-4 max-[640px]:text-[12px] pt-8">Update</p>
                            </div>
                            <div className="flex flex-row gap-20">
                                <p className="text-[15px] font-ROBOTO font-medium opacity-50 max-[640px]:text-[12px]">Category</p>
                                <p className="text-[18px] font-ROBOTO font-bold  max-[640px]:text-[18px] max-[1219px]:pl-8">
                                    {/* Apparel & Accessories */}
                                    {AllData.category}
                                    </p>
                            </div>
    
                            <div className="w-full h-[.1rem] bg-[#00000042]"></div>
    
                            <div className="flex flex-row gap-20">
                                <p className="text-[15px] font-ROBOTO font-medium opacity-50 max-[640px]:text-[12px]">Sub Category</p>
                                <p className="text-[18px] font-ROBOTO font-bold  max-[640px]:text-[18px]">
                                    {AllData.subcategory}
                                    {/* Accessories */}
                                    </p>
                            </div>
                            
                            <div className="flex flex-col  gap-3 pt-5 pr-20 border w-[116.5%] max-[600px]:w-[120%] max-[1219px]:w-[115%] -ml-7 pl-7 pb-5">
                                <div className="flex flex-row justify-between pb-4">
                                    <p className="text-[18px] font-ROBOTO font-bold  max-[640px]:text-[18px]">Pickup Date:</p>
                                    <p className="text-[15px] font-ROBOTO font-bold  text-[#EAB54F] max-[640px]:text-[12px] mr-[-50px]">Update</p>
                                </div>
                                        <p className="text-[15px] font-ROBOTO font-medium opacity-70 max-[640px]:text-[12px]">
                                            {AllData.pickupdate}
                                            {/* 10/02/2023 */}
                                            </p>
                                </div>
    
                                <div className=" h-full w-full ml-[-28px] items-center pt-3 pb-5 max-[711px]:pb-0">
                                    
                                    <button onClick={handleClick}
                                    className="w-[220px] max-[708px]:mb-0 max-[711px]:w-[140px] ml-[4.3rem] max-[475px]:text-[13px] max-[475px]:w-[150px] max-[1024px]:w-[243px] max-[1024px]:h-[40px] h-[49px]  text-black text-[16px] font-semibold font-ROBOTO rounded-lg  bg-[#EAB54F]">Next</button>
