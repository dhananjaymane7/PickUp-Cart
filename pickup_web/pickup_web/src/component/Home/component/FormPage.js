...
const FormPage = () => {
    ...
    const { pickupDetails, deliveryDetails, packageDetails, price, selectedRate, sharedExpressRate, sharedAirRate, cahargablWeight } = location.state || {};
    const formattedExpressRate = parseFloat(sharedExpressRate);
    const formattedAirRate = parseFloat(sharedAirRate);
    ...
    const [formData, setFormData] = useState({
        ...
        packageType: "parcel",
        shiptype: sharedExpressRate > 0 ? " Pickup Express" : " Pickup Air" || "",
        ChargableWeight: cahargablWeight + " " + "kg" || "",
        weight: packageDetails?.parcelWeight+ " " + "kg" || "",
        length: packageDetails?.length || "",
        width: packageDetails?.width || "",
        height: packageDetails?.height || "",
        price: sharedExpressRate > 0 ? formattedExpressRate : formattedAirRate || "",
    ...
    return (
        <div className="container  bg-slate-100 ">
            ...
            <form className="lg:grid  pt-6 pb-10 lg:mx-20 gap-8 lg:grid-cols-3" onSubmit={handleSubmit}>
                    ...
                    <div>
                        ...
                        <div className="md:grid md:grid-cols-2 gap-x-4">
                            <div class="relative z-0 w-full mb-5 group">
                                ...
                                <label class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">delevery person name</label>
                            </div>
                            <div class="relative z-0 w-full mb-5 group">
                ...
                <div className="bg-white px-8 sm:mt-6 lg:mt-0 pt-8 max-w-xl rounded-lg shadow-lg p-8 mx-auto" >
                    ...
                    <div className=" ">
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            <input value={formData.ChargableWeight}
                                onChange={(e) => setFormData({ ...formData, ChargableWeight: e.target.value })} class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                            <label class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Chargable Weight (in kg) </label>
                        </div>
                        <div class="relative z-0 w-full mb-5 group">
                            ...
                            <label class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Actual Weight (in kg) </label>
                        </div>
                        <div class="relative z-0 w-full mb-5 group">
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            <input type="text" value={formData.length} class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6">
                            <div class="relative z-0 w-full mb-5 group">
                                <input type="text" value={formData.height} class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                            ...
                            <div class="relative z-0 w-full mb-5 group">
                                <input type="text" value={formData.width} disabled class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            <input type="text"  class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                            <label class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Parcel Description</label>
                        </div>
                    </div>
                    {showSpinner ?
                    ...
                    <div class="  shadow-md border lg:mt-0  bg-white rounded-xl  ">
                        <div class=" pb-10 ">
                            ...
                            <div class="  px-10">
                                ...
                                <p class=" text-gray-500 pt-1">  <strong>Package Type :</strong> Parcel</p>
                            </div>
                            <div class=" w-72 lg:w-5/6 m-auto bg-indigo-50 mt-5 p-4 lg:p-4 rounded-2xl">
                                <div class="  pt-1">
                                    <p class="text-gray-800 text-center font-bold lg:text-xl"> Amount :
                                        ₹   {sharedExpressRate > 0 ? formattedExpressRate.toFixed(0) : formattedAirRate.toFixed(0)}

                                        {/* { formattedExpressRate === 6 ? formattedExpressRate : formattedAirRate } */}
